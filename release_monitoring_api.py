...
response = requests.get(url="https://release-monitoring.org/api/project/201", timeout=60)
json_dict = json.loads(response.content)
# pprint(json_dict.keys())
print(json_dict["name"])

# https://release-monitoring.org/static/docs/api.html#get--api-v2-versions-
response = requests.get(url="https://release-monitoring.org/api/v2/versions/", params={"project_id": 201}, timeout=60)
json_dict = json.loads(response.content)
# pprint(json_dict.keys())
